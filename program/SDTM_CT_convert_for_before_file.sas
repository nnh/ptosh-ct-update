...
%let root = \\ARONAS\Datacenter\Users\ohtsuka\2020\20210304\ptosh-ct-update\input\rawdata;
...
*+-----------------------------------------------------------------------+
 |  processing                                                           |
 +-----------------------------------------------------------------------+;
%let original = SDTM Terminology 2017-12-22.txt;
%let out_filename = SDTM Terminology 2017-12-22;
